    ...
    @section('content')
        ...
        <div class="card shadow-sm">
            <div class="card-body">
                ...
                <p class="card-text">Anda masuk sebagai role: <strong>{{ auth()->user()->getRoleNames()->first() }}</strong>.</p>
                <p>Gunakan menu di samping untuk mengelola transaksi dan data lainnya.</p>
            </div>
        </div>
        @endrole
    @endsection
