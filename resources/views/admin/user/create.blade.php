            ...
            <form action="{{ route('users.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body p-9">
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-lg">
                            <select name="role" class="form-select custom-placeholder  @error('role') is-invalid @enderror " data-control="select2"  data-placeholder="Pilih Status">
                ...
                <div class="card-footer d-flex justify-content-end py-6 px-9">
                    <a href="{{ route('users.index') }}" type="reset" class="btn btn-light btn-active-light-primary me-2">Batalkan</a>
